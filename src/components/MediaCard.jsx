...
export default function MediaCard({maxWidthCard, heightImg, producto, btnLookDatail }) {
  const { addToCart } = useCart();
  return (
    <Card sx={{ maxWidth: maxWidthCard || 345 }} 
      ...
      <CardActions>
        ...
        >
          <FaShoppingCart className="text-blue-200 text-xl pr-1" />
          Comprar
        </Button>
